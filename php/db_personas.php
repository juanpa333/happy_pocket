...
$_personas_servicio_interes = $_POST['personas_servicio_interes'];
...
try {
    ...
    $sql = "INSERT INTO personas (servicio_interes , nombre , correo ,  celular , comentarios , fecha) VALUES ('$_personas_servicio_interes','$_nombre', '$_email',  '$_celular' , '$_comentarios' , '$_fecha' )";
