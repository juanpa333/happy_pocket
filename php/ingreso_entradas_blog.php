...
$query_consulta_existencia = "SELECT id FROM blog WHERE id = '$_id'";

$resultado_existencia_titulo = $conn->query($query_consulta_existencia);
if ($resultado_existencia_titulo->num_rows > 0){

  $query_modificar_registro_entrada = "UPDATE blog SET 
        titulo = '$_titulo' ,
        entrada_comprimida = '$_entrada_comprimida',
