...
<div class="container mb-5">
  <div class="row justify-content-center text-align">
    ...
    <div class="col-md-6 mb-3 "  id="articulo_7">
      <center><img src="recursos/retos_inversionista.jpg" alt="" class="img-fluid mt-3 "></center>
       <p class="mx-3">
         5 - Abril - 2022
       </p>
       <h3 class="mx-3" >
        LOS RETOS DE INFORMACIÓN QUE ENFRENTA UN INVERSIONISTA
       </h3>
        <p class="mx-3">
    ...
    <div class="col-md-6 mb-3 "  id="articulo_1">
      <center><img src="recursos/inequality.jpg" alt="" class="img-fluid mt-3 "></center>
       ...
       <h3 class="mx-3" >
         EDUCACIÓN FINANCIERA PARA LUCHAR CONTRA LA DESIGUALDAD
       </h3>
        <p class="mx-3">
    ...
    <div class="col-md-6 mb-3 " id="articulo_3">
     <center><img src="recursos/financial_freedom.jpg" alt="" class="img-fluid mt-3 "></center>
      <p class="mx-3">
        28 - Febrero - 2022
      </p>
      <h3 class="mx-3" >
        PASOS PARA TU LIBERTAD FINANCIERA
      </h3>
       <p class="mx-3">
    ...
    <div class=" col-md-6 mb-3 " id="articulo_4">
      <center><img src="recursos/banrepublica.jpg" alt="" class="img-fluid mt-3 "></center>
       <p class="mx-3">
         3 - Febrero - 2022
       </p>
       <h3 class="mx-3" >
        ¿COMO IMPACTA MI BOLSILLO EL AUMENTO DE LA TASA DE INTERÉS?
       </h3>
        <p class="mx-3">
     ...
     <div class="col-md-6 mb-3 " id="articulo_5">
      <center><img src="recursos/china_usa.png" alt="" class="img-fluid mt-3 "></center>
       <p class="mx-3">
         25 - Septiembre - 2021 
       </p>
       <h3 class="mx-3" >
        ENTRE EVERGRANDE Y LA FED
       </h3>
        <p class="mx-3">
     ...
     <div class="col-md-6 mb-3 " id="articulo_6">
      <center><img src="recursos/inflacion.jpeg" alt="" class="img-fluid mt-3 "></center>
       <p class="mx-3">
         22 Septiembre - 2021
       </p>
       <h3 class="mx-3" >
